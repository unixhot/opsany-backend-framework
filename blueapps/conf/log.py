        ...
        'handlers': {
            ...
            'root': {
                ...
                'filename': os.path.join(
                    log_dir, '%s-django.base' % log_name_prefix),
            ...
            'component': {
                ...
                'formatter': 'verbose',
                'filename': os.path.join(
                    log_dir, '%s-component.base' % log_name_prefix),
                'maxBytes': 1024 * 1024 * 10,
                'backupCount': 5
            },
            'mysql': {
                ...
                'formatter': 'verbose',
                'filename': os.path.join(
                    log_dir, '%s-mysql.base' % log_name_prefix),
                'maxBytes': 1024 * 1024 * 10,
                'backupCount': 5
            },
            'celery': {
                ...
                'formatter': 'verbose',
                'filename': os.path.join(
                    log_dir, '%s-celery.base' % log_name_prefix),
                'maxBytes': 1024 * 1024 * 10,
                'backupCount': 5
            },
            'blueapps': {
                ...
                'filename': os.path.join(
                    log_dir, '%s-django.base' % log_name_prefix),
                # TODO blueapps base 等待平台提供单独的路径
                # log_dir, '%s-blueapps.base' % log_name_prefix),
                'maxBytes': 1024 * 1024 * 10,
                'backupCount': 5
            },
        },
